...
mixin _$AppUser {
 ...
 int get id; String get username;@JsonKey(name: 'nama') String get nama; String get nik; String get jabatan;@JsonKey(name: 'tanggal_bergabung') DateTime get tanggalBergabung;@JsonKey(name: 'status_aktif') bool get statusAktif;/// Flag dari backend: TRUE bila ada `face_embeddings.is_aktif = TRUE`.
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,username,nama,nik,jabatan,tanggalBergabung,statusAktif,hasFaceEnrolled);

@override
String toString() {
  return 'AppUser(id: $id, username: $username, nama: $nama, nik: $nik, jabatan: $jabatan, tanggalBergabung: $tanggalBergabung, statusAktif: $statusAktif, hasFaceEnrolled: $hasFaceEnrolled)';
}
...
@useResult
$Res call({
 int id, String username,@JsonKey(name: 'nama') String nama, String nik, String jabatan,@JsonKey(name: 'tanggal_bergabung') DateTime tanggalBergabung,@JsonKey(name: 'status_aktif') bool statusAktif,@JsonKey(name: 'has_face_enrolled') bool hasFaceEnrolled
});
...
/// Create a copy of AppUser
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? username = null,Object? nama = null,Object? nik = null,Object? jabatan = null,Object? tanggalBergabung = null,Object? statusAktif = null,Object? hasFaceEnrolled = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String username, @JsonKey(name: 'nama')  String nama,  String nik,  String jabatan, @JsonKey(name: 'tanggal_bergabung')  DateTime tanggalBergabung, @JsonKey(name: 'status_aktif')  bool statusAktif, @JsonKey(name: 'has_face_enrolled')  bool hasFaceEnrolled)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AppUser() when $default != null:
return $default(_that.id,_that.username,_that.nama,_that.nik,_that.jabatan,_that.tanggalBergabung,_that.statusAktif,_that.hasFaceEnrolled);case _:
  return orElse();
...
/// Create a copy of AppUser
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? username = null,Object? nama = null,Object? nik = null,Object? jabatan = null,Object? tanggalBergabung = null,Object? statusAktif = null,Object? hasFaceEnrolled = null,}) {
