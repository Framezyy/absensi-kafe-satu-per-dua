            ...
            <div class="grid gap-5 sm:grid-cols-2">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="tarif_harian" value="{{ old('tarif_harian', (int) $k->tarif_gaji_harian) }}" min="0" class="w-full rounded-2xl border border-stone-200 bg-white py-3 pl-10 pr-4 text-sm outline-none transition focus:border-amber-500 focus:ring-4 focus:ring-amber-500/15">
                    </div>
                </div>
                <div>
